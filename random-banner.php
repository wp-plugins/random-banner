...
class buffercode_random_banner_info extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if (!empty($buffercode_RBanner_title)) {
            echo $before_title . $buffercode_RBanner_title .
            $after_title;
        }
        ...
        if (!empty($buffercode_RBanner_img_var_WO_empty[$buffercode_RBanner_rand_numb])) {
            echo '<div class="random_banner_css"> <a href="' . $buffercode_RBanner_img_url_WO_empty[$buffercode_RBanner_rand_numb] . '" alt="' . $buffercode_RBanner_img_url_WO_empty[$buffercode_RBanner_rand_numb] . '" target="_blank">';
